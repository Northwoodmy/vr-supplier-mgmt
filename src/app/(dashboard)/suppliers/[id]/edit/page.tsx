      ...
      try {
        ...
        if (res.ok) {
          ...
          setFormData({
            ...
            registeredCapital: data.registeredCapital ? data.registeredCapital.toString() : '',
            ...
            totalMembers: data.capacity?.totalMembers || 0,
            capacityFactor: data.capacity?.capacityFactor.toString() || '0.8',
          });
          ...
          if (data.coreMembers) {
            try {
              setCoreMembers(JSON.parse(data.coreMembers));
            } catch (e) {
              console.error('Failed to parse coreMembers:', e);
            }
          }
          ...
          if (data.equipment) {
            try {
              setEquipments(JSON.parse(data.equipment));
            } catch (e) {
          ...
          if (data.sampleWorks) {
            try {
              setSampleWorks(JSON.parse(data.sampleWorks));
            } catch (e) {
              console.error('Failed to parse sampleWorks:', e);
            }
          }
        }
      } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">修改供应商详细信息</p>
        </div>
      </div>
